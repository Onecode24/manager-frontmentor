<template>
  <div class="footer md:flex justify-around md:my-5">
    <div class="md:order-3">
        <div class="inputs flex justify-between">
            <input-global class="py-1 rounded-[15px] md:rounded-[25px] md:mr-5 pl-5" placeholder="Updated in your inbox..."></input-global>
            <button-global class="py-1 font-medium">Go</button-global>
        </div>
        <div class="copyright hidden md:flex md:visible ">
            <p class="copyright md:text-right md:ml-[40%]">Copyright 2020. All Right Reserved</p>
        </div>
    </div>
    <div class="list flex justify-around my-10 md:my-0 md:order-2">
        <div class="pages md:mr-10">
            <a class="block">Home</a>
            <a class="block">Pricing</a>
            <a class="block">Products</a>
            <a class="block">About Us</a>
        </div>
        <div class="other md:ml-10">
            <a class="block">Careers</a>
            <a class="block">Community</a>
            <a class="block">Privacy Policy</a>
        </div>
    </div>

    <div class="media-logo text-center  ">
        <div class="medias flex justify-around mb-10" >
...
<script>
    import InputGlobal from './global/Input-Global.vue';
    import ButtonGlobal from './global/Button-Global.vue';
export default {
    components:{
        InputGlobal,ButtonGlobal
    }
}
</script>
